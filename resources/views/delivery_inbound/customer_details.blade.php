                        ...
                        <form class="form-horizontal" method="POST" action="{{ route(BladeAcl::getRoute('delivery_inbounds.update'), $deliveryInbound->id) }}">
                            ...
                            <div class="card-body">
                                        ...
                                        <table class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="number" class="form-control" id="inputDeliveryInboundItemId" name="deliveryInboundItems[{{ $deliveryInboundItem->id }}]" value="{{ $deliveryInboundItem->quantity }}" @if ($deliveryInbound->status === 'PENDING') disabled @endif>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="inputOwnerNotes" name="owner_notes" value="{{ $deliveryInbound->owner_notes }}" disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                            ...
                            <div class="card-footer">
                                ...
                                @if ($deliveryInbound->status === 'DISPUTE')
